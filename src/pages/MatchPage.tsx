    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-5xl px-4 py-8">
        ...
        <div className="overflow-hidden rounded-2xl border border-border shadow-card">
          ...
          <div className="bg-card p-8">
            <div className="flex items-center justify-center gap-8">
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-secondary text-2xl font-black text-primary">
                  {MATCH.team1}
                </div>
              ...
              {/* Team 2 */}
              <div className="flex flex-col items-center gap-2">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-secondary text-2xl font-black text-warning">
                  {MATCH.team2}
                </div>
          ...
          <div className="border-t border-border bg-card p-6">
            <div className="flex items-center justify-between rounded-xl border border-primary/20 bg-primary/5 p-4">
              <div>
                <h3 className="font-bold text-foreground">Mega Contest</h3>
              ...
              <button
                onClick={handleJoin}
                className="gradient-primary rounded-xl px-6 py-2.5 text-sm font-bold text-primary-foreground shadow-glow transition-transform hover:scale-[1.02] active:scale-[0.98]"
              >
                {user.paid ? "Select Team" : `Join Contest ₹${MATCH.contestFee}`}
              </button>
            </div>

            {user.transactionId && !user.paid && (
              <div className="mt-4 rounded-xl border border-warning/20 bg-warning/5 p-3 text-center text-sm text-warning">
                ⏳ Payment submitted — Waiting for admin approval
              </div>
            )}

            {user.paid && (
              <div className="mt-4 rounded-xl border border-success/20 bg-success/5 p-3 text-center text-sm text-success">
        ...
        <div className="mt-8 rounded-2xl border border-border bg-card p-6 shadow-card">
          <h3 className="mb-4 text-lg font-bold">Point System</h3>
